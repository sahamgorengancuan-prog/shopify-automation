...
REM    run_pipeline.bat --house                 V10.1 house system end to end
REM    run_pipeline.bat --house --topic harbor  house system on a chosen signal
REM    run_pipeline.bat --volume --roots a,b    compare volume across your terms
...
echo          run_pipeline.bat --house [options]     V10.1 house system
